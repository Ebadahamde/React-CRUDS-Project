...
export default function Todo({ todo }) {
  ...
  const [NewupdateInpout, setNewupdateInpout] = useState({title:"" , details:""});
    ...
    <>
      ...
      >
        ...
        <DialogContent>
         ...
         <TextField sx={{margin:"10px "}} id="outlined-basic" label="Outlined" variant="outlined"
         value={NewupdateInpout.title}
         onChange={(x)=>{
          setNewupdateInpout({...NewupdateInpout , title: x.target.va})
         }}/>
