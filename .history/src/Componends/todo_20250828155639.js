...
export default function Todo({ todo }) {
  ...
  function HnadelCheckClick() {
    ...
    localStorage.setItem("todos", JSON.stringify(HnadelCheckClick));
  }
  ...
  function HandelDelateConferm() {
    ...
    settodos(newTodo);
    localStorage.setItem("todos", JSON.stringify(HandelDelateConferm));
  }
  ...
  function HandelUpdateNewTodo() {
    ...
    localStorage.setItem("todos", JSON.stringify(HandelUpdateNewTodo));
